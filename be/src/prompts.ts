import type { DesignScheme } from './design';
...
<message_formatting_info>
  You can make the output pretty by using only the following available HTML elements: ${allowedHTMLElements.map((tagName :any) => `<${tagName}>`).join(', ')}
</message_formatting_info>
