...
const getSystemPrompt = (cwd = constants_1.WORK_DIR, supabase, designScheme) => {
    var _a, _b;
    return `
  ...
  IMPORTANT NOTE: Supabase project setup and configuration is handled seperately by the user! ${supabase
        ? !supabase.isConnected
            ...
            : !supabase.hasSelectedProject
                ...
                : ''
        : ''} 
    IMPORTANT: Create a .env file if it doesnt exist${(supabase === null || supabase === void 0 ? void 0 : supabase.isConnected) &&
        (supabase === null || supabase === void 0 ? void 0 : supabase.hasSelectedProject) &&
        ((_a = supabase === null || supabase === void 0 ? void 0 : supabase.credentials) === null || _a === void 0 ? void 0 : _a.supabaseUrl) &&
        ((_b = supabase === null || supabase === void 0 ? void 0 : supabase.credentials) === null || _b === void 0 ? void 0 : _b.anonKey)
  ...
  <design_instructions>
    ...
    Technical Excellence:
      ...
      <user_provided_design>
        ...
        FONT: ${JSON.stringify(designScheme === null || designScheme === void 0 ? void 0 : designScheme.font)}
        COLOR PALETTE: ${JSON.stringify(designScheme === null || designScheme === void 0 ? void 0 : designScheme.palette)}
        FEATURES: ${JSON.stringify(designScheme === null || designScheme === void 0 ? void 0 : designScheme.features)}
      </user_provided_design>
  </design_instructions>
</artifact_info>
